...
function App() {
  ...
  {
    id: 3,
    description: "No tengas miedo, será genial🤗❤️",
  ...
  {
    id: 6,
    description: "Te prometo que será inolvidable❤️‍🔥😋",
  ...
  {
    id: 10,
    description: "Ctm que haces aqui",
    ...
    <main id="canvas" className="fondo w-screen h-screen bg-no-repeat bg-cover flex items-center justify-center bg-center ">
      {
        !valueSi ? (
          <div className="p-5">
            <h1 className="text-white font-bold text-5x1 text-center">Alesandra Suárez</h1>
            <h1 className="text-white font-bold text-5xl text-center">¿Quieres ser mi San Valentin?🥹❤️</h1>
          ...
          <div className="flex justify-center items-center flex-col space-y-10">
            ...
            <img src="https://i.ibb.co/spT3mNB6/STK-20250131-WA0205.webp" alt="" className="mx-auto" />
